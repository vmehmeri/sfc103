...
vagrant ssh spn -c "sudo docker run spn python /sfc103/setup.py"
vagrant ssh spn -c "sudo docker run spn python /sfc103/setup1.py"
vagrant ssh spn -c "sudo docker run spn python /sfc103/setup2.py"
sleep 60
